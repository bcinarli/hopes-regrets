...
!function(e,s){"use strict";var o="1.0.0",t=e.BenNeHaltEttim={modules:{},version:o};t.modules.system=s.module("BNHE.System",[]),t.modules.controllers=s.module("BNHE.Controllers",[]),t.modules.filters=s.module("BNHE.Filters",[]),t.modules.directives=s.module("BNHE.Directives",[]),t.modules.services=s.module("BNHE.Services",["ngResource","ngCookies"]),t.modules.routes=s.module("BNHE.Routes",["ngRoute"]),t.modules.app=s.module("BenNeHaltEttim",["BNHE.System","BNHE.Controllers","BNHE.Filters","BNHE.Directives","BNHE.Services","BNHE.Routes"]),t.modules.system.constant("bnheConfig.Defaults",{baseUrl:"",templatesDirectory:"assets/templates/"})}(window,angular);
!function(t){"use strict";var e=t.BenNeHaltEttim,r=e.modules.system,a=function(){var t=1e6*Math.random()|0,e={baseUrl:"",templatesDirectory:""};this.setBaseUrl=function(t){e.baseUrl=t},this.setTemplatesDirectory=function(t){e.templatesDirectory=t};var r=function(){var r={addBaseUrl:function(t){return e.baseUrl+t},addTemplatesDirectory:function(r){return e.baseUrl+e.templatesDirectory+r+"?v="+t}};return r};this.$get=r};r.provider("bnheSystem",a)}(window,angular);
!function(e){"use strict";var t=e.BenNeHaltEttim,r=t.modules.system,s=function(e,t,r){e.enabled(!1);var s=function(e){e.baseUrl&&r.setBaseUrl(e.baseUrl),e.templatesDirectory&&r.setTemplatesDirectory(e.templatesDirectory)};s(t)};r.config(["$sceProvider","bnheConfig.Defaults","bnheSystemProvider",s])}(window,angular);
!function(e){"use strict";var t=e.BenNeHaltEttim,r=t.modules.routes,u=function(e,t){var r=[{id:1,auth:0,order:0,type:"guest",route:"welcome",controller:"bnheWelcomeCtrl",templateUrl:"welcome.tpl"}],u=t.$get(),o=!1,n={run:function(e,t){return"undefined"==typeof t&&(t="getRouteById"),function(r){var u=Array.prototype.slice.call(arguments,1),o=n[t](r);return u.unshift(o),n[e].apply(n,u)}},currentRoute:null,getCurrentRoute:function(){return n.currentRoute},getRouteList:function(){return r},getRoute:function(e){return _.find(r,e)},getRouteType:function(e){return e.type},getRouteById:function(e){return this.getRoute({id:+e})},getRouteByPath:function(e){return this.getRoute({route:e})},getRouteByOrder:function(e){return this.getRoute({order:e})},getRoutePathById:function(e){return"/"+e.route},getRouteTemplateUrl:function(e){return u.addTemplatesDirectory(e.type+"/"+e.templateUrl)},redirectRoute:function(e,t,r){e.path(t.route,r)},redirectRouteMethod:function(e,t){this.redirectRoute(e,t)}},i={getCurrentRoute:n.getCurrentRoute,getRoute:n.getRoute,getRouteList:n.getRouteList,getRouteById:n.getRouteById,getRouteByPath:n.getRouteByPath,getRouteByOrder:n.getRouteByOrder,getRouteTypeByOrder:n.run("getRouteType","getRouteByOrder"),getRoutePathById:n.run("getRoutePathById"),getFullUrl:n.run("getFullUrl"),getRouteTemplateUrl:n.run("getRouteTemplateUrl"),redirectRouteByOrder:n.run("redirectRouteMethod","getRouteByOrder"),redirectRouteById:n.run("redirectRouteMethod","getRouteById"),redirectRouteByPath:n.run("redirectRouteMethod","getRouteByPath")},l=function(e){if(o)return i;var t=e.$location;return n.redirectRoute=_.curry(n.redirectRoute)(t),o=!0,i};this.$get=["$location",function(e){return l({$location:e})}];var R=function(){_.each(r,function(t){var r={resolve:{setCurrentRoute:["$q",function(e){return n.currentRoute=t,e.when()}]}};t.controller&&(r.controller=t.controller),t.templateUrl&&(r.templateUrl=i.getRouteTemplateUrl(t.id)),t.template||t.templateUrl||(r.template=" "),r.routeInfo=t,e.when(i.getRoutePathById(t.id),r)}),e.otherwise({redirectTo:"/welcome"})};R()};r.provider("bnheRoute",["$routeProvider","bnheSystemProvider",u])}(window,angular);
<<<<<<< Updated upstream
!function(t){"use strict";var n=t.BenNeHaltEttim,e=n.modules.controllers,o=function(t){t.model={},t.settings={page_loading:!1,content_loading:!1}};e.controller("bnheSystemCtrl",["$scope",o])}(window);
=======
!function(t){"use strict";var e=t.BenNeHaltEttim,n=e.modules.controllers,o=function(t){t.model={},t.settings={preloading:!1}};n.controller("bnheSystemCtrl",["$scope",o])}(window);
>>>>>>> Stashed changes
!function(e){"use strict";var o=e.BenNeHaltEttim,t=o.modules.controllers,n=function(){};t.controller("bnheWelcomeCtrl",["$scope",n])}(window);